function [r_opt, y_opt, Q_final, lin_final] = opt_refs_uav(sysd, x0, t0, N, tau, yTildex, yTildey, beta)
    ...
    [r_opt.x, Q_final.x, lin_final.x] = opt_refs_PDcontrol_DBLint(lam1, lam2, [x0(1);x0(3)], t0, N, tau, yTildex, beta);
    [r_opt.y, Q_final.y, lin_final.y] = opt_refs_PDcontrol_DBLint(lam1, lam2, [x0(2);x0(4)], t0, N, tau, yTildey, beta);
